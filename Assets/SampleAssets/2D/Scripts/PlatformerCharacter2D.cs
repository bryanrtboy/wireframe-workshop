...
namespace UnitySampleAssets._2D
{
		...
		public class PlatformerCharacter2D : MonoBehaviour
		{
				...
				public GameObject	m_playerEffects;						//Object where we can send messages for playing effects
				...
				public void Move (float move, bool crouch, bool jump)
				{
                    ...
                    // ... flip the player.
						...
						if (grounded && jump && anim.GetBool ("Ground")) {
								...
								if (m_playerEffects)
										m_playerEffects.SendMessage ("JumpSound", SendMessageOptions.DontRequireReceiver);
						}
				}
